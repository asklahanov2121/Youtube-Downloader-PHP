...
Youtube URL: $endcolor";
    ...
    $urlurl = urlencode($aikawas);
    $download = file_get_contents("https://loader.to/ajax/download.php?format=1080&url=$urlurl", true);
...
Server Error!$endcolor\n";
            ...
            $downloaderzs = file_put_contents("./video/$title.mp4", $mpz);
            echo "$purple
